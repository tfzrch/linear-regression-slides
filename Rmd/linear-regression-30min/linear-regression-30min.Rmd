...
source(here::here("R", "xaringanthemer.R"))
xaringan_theme()
...
- You work as a data scientist for a company that makes cookies

--

- The government is proposing taxes on foods with calorie counts higher
  than a certain threshold

--

- Your company wants to be ready to put new products into production
...
- You have a team of bakers and food scientists creating proposals for new
  recipes
  
--

- They want to test only recipes likely to have calories below the 
  threshold.
